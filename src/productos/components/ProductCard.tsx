...
import { addProductToCart, removeCart } from "@/shopping-cart/actions/action";
        ...
        <div className=" shadow rounded-lg max-w-sm bg-gray-800 border-gray-100">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <span className="bg-blue-100 text-xs font-semibold mr-2 px-2.5 py-0.5 roundedbg-blue-200 text-blue-800 ml-3">
                        {rating.toFixed(2)}
                    </span>
                </div>
                ...
                <div className="flex items-center justify-between">
                    <span className="text-2x font-bold text-white">${price.toFixed(2)}</span>
